...
select yn in "P4STA Core + HTML-GUI (recommended)" "P4STA Core(VERBOSE) + HTML-GUI" "P4STA Core + CLI" "Just P4STA Core (VERBOSE)"; do
    case $yn in
		...
		"P4STA Core(VERBOSE) + HTML-GUI" ) (python3 core/core.py&); python3 manage.py runserver 0.0.0.0:9997; break;;
        "P4STA Core + CLI" ) (python3 core/core.py>/dev/null&); sleep 1; python3 cli/cli.py; break;;
