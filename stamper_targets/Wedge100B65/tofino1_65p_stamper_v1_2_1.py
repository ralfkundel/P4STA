...
class TargetImpl(AbstractTarget):
    ...
    def __init__(self, target_cfg):
        ...
        print("tofino1_65p_stamper_v1_2_1 init")
    ...
    def deploy_tables(self, cfg, interface):
        ...
        try:
            ...
            try:
                ...
                print("Deploying broadcast_mac table UDP: P4 seems to be compiled for GTP-U. Try outer_ipv4 ...")
                interface.add_to_table(
                    t_broadcast_mac,
                    [
                        ["eg_intr_md.egress_port", int(cfg["ext_host"])],
            ...
            try:
                ...
                print("Deploying broadcast_mac table TCP: P4 seems to be compiled for GTP-U. Do nothing.")
    ...
    def get_server_install_script(self, user_name, ip, target_specific_dict={}):
        ...
        compile_p4_src = "export SDE_INSTALL=" + sde_path + "/install\n" \
                         ...
                         "mkdir -p compile\n" \
                         "$SDE_INSTALL/bin/bf-p4c -v "+ p4c_flags +" -o $PWD/compile/ tofino_stamper_v1_2_1.p4\n"
        ...
        lst.append('echo "P4 compile flag: ' + target_specific_dict["compile_flag"] + '"')
        lst.append('echo "====================================="')
        ...
        lst.append('  scp ' + dir_path + '/p4_files/v1.2.1/header_tofino_stamper_v1_2_1.p4 ' + user_name + '@' + ip + ':/home/' + user_name + '/p4sta/stamper/tofino1/')
        lst.append('  scp ' + dir_path + '/p4_files/v1.2.1/tofino_stamper_v1_2_1.p4 ' + user_name + '@' + ip + ':/home/' + user_name + '/p4sta/stamper/tofino1/')
